...
class EpisodeRatingService {
    ...
    suspend fun getAverageForSeries(seriesId: String): Float = dbQuery {
    ...
    suspend fun getAverageForSeason(seriesId: String, seasonId: Int): Float = dbQuery {
        val avgColumn = EpisodeRatings.rating.avg()
        val result = EpisodeRatings.slice(
            avgColumn
    ...
    suspend fun getAverageForEpisode(seriesId: String, seasonId: Int, episodeId: Int): Float = dbQuery {
        val avgColumn = EpisodeRatings.rating.avg()
        val result = EpisodeRatings.slice(
            avgColumn
        ).select { EpisodeRatings.seriesId eq seriesId }
